        ...
        <BarChart data={data} layout="vertical" margin={{ top: 4, right: 16, left: 8, bottom: 4 }} barCategoryGap={6}>
          <defs>
            <linearGradient id="pnlUp" x1="0" y1="0" x2="1" y2="0">
              <stop offset="0%" stopColor="#3f57cc" stopOpacity={0.5} />
              <stop offset="100%" stopColor="#7d97ff" stopOpacity={0.95} />
            </linearGradient>
            <linearGradient id="pnlDown" x1="0" y1="0" x2="1" y2="0">
              <stop offset="0%" stopColor="#c23a48" stopOpacity={0.5} />
              <stop offset="100%" stopColor="#ff5d6c" stopOpacity={0.9} />
            </linearGradient>
          </defs>
          <XAxis
            type="number"
          ...
          <YAxis
            ...
            tickLine={false}
          />
          <Tooltip cursor={{ fill: "rgba(91,124,255,0.08)" }} content={<CustomTooltip />} />
